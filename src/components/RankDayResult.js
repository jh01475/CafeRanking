import '../css/RankDayResult.css'
import PostList from './PostList.js'
import { useEffect, useState } from 'react';
import axios from 'axios';

function RankDayResult() {

////////////////////// 서버로부터 크롤링 일간 데이터를 가져옴
    ...
    const getBoard = async() => {
        const result=await axios('/article/daily')
        console.log("일간")
        console.log(result)     // localhost:4000/article/daily 데이터가 표기 되면 성공!
