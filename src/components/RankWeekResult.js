...
////////////////////// 서버로부터 크롤링 주간 데이터를 가져옴
    ...
    const getBoard = async() => {
        const result=await axios('/article/weekly')
        console.log("주간")
        console.log(result)     // localhost:4000/article/weekly 데이터가 표기 되면 성공!
